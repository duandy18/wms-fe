// src/features/wms/outbound-pick/OutboundPickHistoryPanel.tsx
//
// 最近操作列表 Panel（拣货扫码探针 / 任务写入）

import React from "react";
import type { PickProbeRequest, PickProbeResponse } from "../scan/api";

export type HistoryEntry = {
  id: number;
  kind: "form" | "scan";
  req: Partial<PickProbeRequest>;
  resp: PickProbeResponse | null;
  error: string | null;
};
