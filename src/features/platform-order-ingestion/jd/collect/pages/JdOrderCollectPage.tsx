  ...
  return (
    <div className={poiUi.page}>
      <section className={poiUi.hero}>
        ...
        <h1 className={poiUi.heroTitle}>京东订单采集</h1>
        <p className={poiUi.heroDesc}>
          本页负责京东平台订单采集链路：系统配置、店铺授权、连接状态、模拟联调、
          拉单任务和任务日志。订单拉取后只落到京东原生订单表，不创建内部订单。
        </p>
        <div className="mt-4 flex flex-wrap gap-2">
          <Link
            to="/platform-order-ingestion/jd/native-orders"
      ...
      <section className={poiUi.grid2}>
        <SkeletonCard
          title="京东系统配置"
          description="展示京东应用配置是否完整，后续接入应用配置读取和保存。"
          points={[
            {
              title: "应用配置状态",
        ...
        <SkeletonCard
          title="拉单任务"
          description="创建并执行京东拉单任务，支持单页执行和连续执行。"
          points={[
            {
              title: "创建任务",
