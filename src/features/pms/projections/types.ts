...
export const PMS_PROJECTION_RESOURCES: PmsProjectionResourceConfig[] = [
  ...
  },
  {
    resource: "suppliers",
    label: "供应商投影",
    routePath: "/pms/supplier-projection",
  ...
  },
  {
    resource: "sku-codes",
    label: "SKU 编码投影",
    routePath: "/pms/sku-code-projection",
  ...
  },
  {
    resource: "barcodes",
    label: "条码投影",
    routePath: "/pms/barcode-projection",
