// src/features/shipping-assist/providers/ui.ts
//
...
export const UI = {
  ...
  inputMono:
    "mt-1 rounded-xl border border-slate-300 px-4 py-3 text-lg font-mono w-full",
  select: "mt-1 rounded-xl border border-slate-300 px-4 py-3 text-lg w-full",
  textareaMono:
    "mt-1 h-40 rounded-xl border border-slate-300 px-4 py-3 text-sm font-mono w-full",
  ...
  theadRow:
    "border-b border-slate-200 bg-slate-50 text-sm font-semibold text-slate-600",
