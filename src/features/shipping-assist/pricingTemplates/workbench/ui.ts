// src/features/shipping-assist/pricingTemplates/workbench/ui.ts
//
// Pricing Workbench 私有 UI tokens（只影响运价工作台，不做全局污染）
// 目标：集中控制“字体大小/密度”，页面组件不再散落 text-sm/text-base 等细节。

import { UI as BaseUI } from "../../providers/ui";

export const UI = {
  ...BaseUI,

  // ===== Common (workbench-scope) =====
