// src/features/shipping-assist/shipment/cockpit/components/ShipmentOrderAddressCard.tsx
//
// 分拆说明：
// - 本组件负责顺序卡 1：订单与地址。
// - 当前页面语义已收口为“地址核对”而不是“发货辅助内解析 / 人工修正”。
// - 正确流程：
//   1) 核对地址
//   2) 地址正确则写入发货辅助状态
//   3) 地址有问题则返回 OMS 处理
  ...
  return (
    <section className={UI.card}>
      ...
      <div className={UI.sectionNote}>
        地址核对正确后，应写入发货辅助地址状态；如地址有问题，不在发货辅助内修改，统一返回 OMS 处理。
      </div>
    </section>
  );
};
