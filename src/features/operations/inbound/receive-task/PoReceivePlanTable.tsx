              ...
              <label className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-slate-700">
                    ...
                    <span className="text-slate-600">{r.base_uom_label}</span>
                  </div>

                  <div className="text-[12px] text-slate-500">
                    （应收 {r.ordered_case} {r.case_uom} · 已收 {r.received_case} {r.case_uom} · 每{r.case_uom}=
                    {r.case_ratio_snapshot} {r.base_uom_label}）
                  </div>
