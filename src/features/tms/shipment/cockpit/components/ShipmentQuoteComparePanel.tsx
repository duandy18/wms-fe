// src/features/shipment/cockpit/components/ShipmentQuoteComparePanel.tsx
...
export const ShipmentQuoteComparePanel: React.FC<Props> = ({
  quotes,
  selectedSchemeId,
  recommendedSchemeId,
  onSelect,
...
export default ShipmentQuoteComparePanel;
