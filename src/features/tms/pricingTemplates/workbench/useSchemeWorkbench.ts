// src/features/tms/pricingTemplates/workbench/useSchemeWorkbench.ts

import { useCallback, useEffect, useMemo, useRef, useState } from "react";
import { fetchPricingSchemeDetail } from "../../pricing/api";
...
export function useSchemeWorkbench(params: {
  open: boolean;
